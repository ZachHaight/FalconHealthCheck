...
# Manually update list_files.json or use manifest generator
...
- **Pricing:** See [`[INT]PricingChanges.md`]([INT]PricingChanges.md) to modify calculator pricing or remove Amazon-specific features
- **Branding:** See [`visualizer branding/README.md`](visualizer%20branding/README.md) to customize logos and visual identity
...
├── visualizer branding/                # Logo and image assets
│   ├── README.md                       # Branding customization guide
│   ├── AWS Logo.png
│   ├── Crowdstrike Logo.png
│   └── CrowdStrike_Logo_2023_Secondary_Black.png
├── DEPLOYMENT.md                       # Full deployment guide
├── QUICKSTART.md                       # 5-minute setup guide
├── [INT]PricingChanges.md             # Pricing customization guide
└── README.md                           # This file
```
